...
<div class="p-6 space-y-6">
    <div>
        <h1 class="text-3xl font-bold text-indigo-950">Tambah Kategori</h1>
        <p class="text-gray-500 text-sm mt-1">Buat nama kategori baru untuk mengelompokkan acara-acara menarik.</p>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" placeholder="Contoh: Seminar IT, Workshop, Music Festival" required value="{{ old('name') }}"
