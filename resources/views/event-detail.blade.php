    ...
    <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div class="lg:col-span-1">
            <div class="sticky top-32">
                ...
                @else
                    <img src="https://placehold.co/600x400?text=No+Image" alt="Default Poster"
                        class="w-full rounded-[2.5rem] shadow-2xl border-8 border-white border-slate-200">
                @endif
        ...
        <div class="lg:col-span-2 space-y-12">
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                    <div class="flex items-center gap-2">
                        ...
                        <span>{{ \Carbon\Carbon::parse($event->date)->format('d F Y, H:i') }} WIB</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div>
                        {{-- Tombol Checkout memanggil ID event secara dinamis --}}
